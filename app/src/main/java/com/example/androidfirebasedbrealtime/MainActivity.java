package com.example.androidfirebasedbrealtime;
...
public class MainActivity extends AppCompatActivity {
        ...
        btn_update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                databaseReference
                        .child(selectedKey)
                        .setValue(new Post(
                                edt_title.getText().toString(), edt_content.getText().toString()))
    ...
    private void postComment() {
        ...
        databaseReference.push()// Use thie method to create unique id of comment
            .setValue(post);
        ...
        adapter =
                new FirebaseRecyclerAdapter<Post, MyRecyclerViewHolder>(options) {
                    ...
                    public MyRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                        View itemView = LayoutInflater.from(getBaseContext()).inflate(R.layout.post_items,viewGroup,false);
